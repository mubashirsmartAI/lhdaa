                ...
                success: function (response) {
                    ...
                    if((response.data != null) && (response.data.user_exists != undefined) && (response.data.user_exists == false)){
                        Swal.fire({
                            ...
                            icon: 'info',
                            iconColor: '{{getClientPreferenceDetail() ? getClientPreferenceDetail()->web_color : '#fff'}}',
                            showCancelButton: true,
                            confirmButtonText: 'Signup',
                            confirmButtonColor: '{{getClientPreferenceDetail() ? getClientPreferenceDetail()->web_color : '#fff'}}'
                        }).then((result) => {
                            if(result.value)
                            {
